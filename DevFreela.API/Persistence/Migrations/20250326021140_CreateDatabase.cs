    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectCommments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectCommments_Projects_IdProject",
                        column: x => x.IdProject,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectCommments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectCommments_IdProject",
                table: "ProjectCommments",
                column: "IdProject");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectCommments_UserId",
                table: "ProjectCommments",
                column: "UserId");
